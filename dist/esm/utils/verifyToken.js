            ...
            case 0: return [4 /*yield*/, new Promise(function (resolve) {
                    try {
                        var options = {
                            ...
                            issuer: "https://".concat(auth0Config.domain, "/"),
                        };
                        var getPublicKey = function (header, callback2) {
                            var jwksC = jwksClient({
                                jwksUri: "https://".concat(auth0Config.domain, "/.well-known/jwks.json"),
                                cache: true,
                            });
                            // console.log(header);
                        ...
                        jwt.verify(tokenValue, getPublicKey, options, function (verifyError, decoded) {
                            ...
                            if (decoded) {
                                ...
                                resolve({ sub: decodedPayload.sub, roles: rolesString });
                            }
                        });
                    }
                    catch (err) {
